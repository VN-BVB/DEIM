from compile_module.ops_dcnv3.test import D
"""
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        ...
        default=r'D:\YOLO\DEIM\DEIM_20251224\DEIM\configs\seg\define-n-seg_MG.yml',
        help='config file path'
    )
    # parser.add_argument('-r', '--resume', type=str, default=r'D:\YOLO\DEIM\DEIM_20251224\DEIM\outputs\deim_hgnetv2_n_custom12\last.pth')
    parser.add_argument('-r', '--resume', type=str,default=None)
    # parser.add_argument('-t', '--tuning', type=str,default=None)
    parser.add_argument('-t', '--tuning', type=str, default=r'D:\YOLO\DEIM\DEIM_20251224\DEIM\outputs\deim_hgnetv2_n_custom12\best_stg1.pth')
