...
if __name__ == '__main__':
    ...
    #     # model
    #     config=r'D:/YOLO/DEIM/DEIM_20251224/DEIM/configs/deim_dfine/deim_hgnetv2_user2.yml',
    #     resume=r'D:/YOLO/DEIM/DEIM_20251224/DEIM/deim_outputs/deim_hgnetv2_n_test/best_stg2.pth',
    #     # onnx
    #     opset=17,
    #     simplify=True,
    #     dynamic=False,
    #
    #     # engine param（ONNX 阶段一般不会用到，但保持字段完整）
    #     half=False,
    #     device='0',
    #     workspace=None,
    #
    ...
    # )
    #
    # print(ORANGE + "========== Export ONNX ==========")
    # print(json.dumps(vars(onnx_args), indent=4, sort_keys=False))
    # print("=================================" + RESET)
    #
    # main(onnx_args)

    # =========================
    # 2. 写死 TensorRT Engine 导出参数
    # =========================
    engine_args = argparse.Namespace(
        # model
        config=r'D:\YOLO\DEIM\DEIM_20251224\DEIM\configs\yaml\user_deim_dfine_hgnetv2_n_mg.yml',
        resume=r'D:\YOLO\DEIM\DEIM_20251224\DEIM\outputs\deim_hgnetv2_n_custom12\best_stg1.pth',

        # onnx（engine 阶段一般不关心，但字段必须在）
        opset=17,
        simplify=False,
        dynamic=False,

        # engine
        half=False,          # ⚠ TensorRT 常用 FP16（true）
        device='0',
        workspace=8,        # GB，可按显存调整
    ...
    print(ORANGE + "========== Export TensorRT Engine ==========")
    print(json.dumps(vars(engine_args), indent=4, sort_keys=False))
    print("============================================" + RESET)
