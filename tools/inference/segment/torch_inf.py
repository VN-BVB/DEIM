...
if __name__ == '__main__':
    ...
    parser.add_argument('-r', '--resume', type=str, default=r'weight\seg\define-s-seg-factory.pth')
    parser.add_argument('-i', '--input', type=str, default=r'D:\YOLO\dataset\3EAweldArea\FactoryPhoto\VOC\JPEGImages')
